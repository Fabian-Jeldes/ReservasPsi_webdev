...
export const SPECIALIZATIONS: Specialization[] = [
  {
    ...
    detailedContent: [
      ...
      "<strong class=\"text-rose-400\">\"La erección no es un interruptor que se enciende a voluntad, sino una respuesta natural que florece cuando apagamos el miedo a fallar.\"</strong>"
    ]
  },
  {
    id: 2,
    ...
    detailedContent: [
      ...
      "<strong class=\"text-rose-400\">\"Tu cuerpo no es un cronómetro; el placer solo encuentra su verdadero ritmo cuando dejas de evaluar tu rendimiento.\"</strong>"
    ]
  },
  {
    id: 3,
    ...
    detailedContent: [
      ...
      "<strong class=\"text-rose-400\">\"No existe el deber de 'estar siempre listo'; tu deseo no se apagó, solo está reaccionando al peso y al estrés de tu rutina.\"</strong>"
    ]
  },
  {
    id: 4,
    ...
    detailedContent: [
      ...
      "<strong class=\"text-rose-400\">\"El mayor obstáculo para el placer no es el cuerpo, sino la exigencia mental que le imponemos.\"</strong>"
    ]
  },
  {
    id: 5,
    ...
    detailedContent: [
      ...
      "<strong class=\"text-rose-400\">\"El silencio alimenta la ansiedad; compartir nuestra vulnerabilidad es lo que verdaderamente fortalece la conexión.\"</strong>"
    ]
  },
  {
    id: 6,
    ...
    detailedContent: [
      ...
      "<strong class=\"text-rose-400\">\"La sexualidad real no compite con una pantalla; desaprender esos estándares irreales es clave para 'reiniciar' tu deseo.\"</strong>"
    ]
  },
]
...
export const ARTICLE_PAGES_DATA: ArticlePageData[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '<strong class="text-white">Lectura recomendada:</strong> Si sientes que el silencio está ganando terreno en tu relación y quieres herramientas para cambiar esta dinámica, te invito a leer mi artículo: <strong class="text-rose-400">[El peso del silencio: Por qué hablar de sexo salva las relaciones]</strong>'
        ],
        images: [
  ...
  },
  {
    ...
    sections: [
      {
        title: 'La presión por la <strong class="text-rose-400">"compatibilidad natural"</strong>',
        paragraphs: [
